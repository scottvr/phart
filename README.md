...
\* except NetworkX, which should be mentioned prominently. We just mean that **phart** will not require you to stand up a webserver to run PHP and install Perl and some libraries just to render a Graph in 7-bit text (or UTF-8 or Unicode) from Python.
