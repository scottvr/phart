...
echo "######################"
echo ""
cmd="phart  --layer-spacing 4 --btree --bbox collatz.py --charset unicode -- 5"
...
echo "######################"
echo ""
cmd="phart  --bbox --layer-spacing 4 --btree --edge-anchors ports --uniform --charset unicode collatz.py -- 4"
...
echo ""
cmd="phart --layout bfs --bbox --layer-spacing 4 --btree --edge-anchors center --uniform  --charset unicode  --colors source   collatz.py -- 7"
echo ""
echo "${cmd} | tail -17"
echo ""
echo "######################"
